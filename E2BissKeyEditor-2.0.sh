...
# Script for installing/updating E2BissKeyEditor plugin

# Plugin information
plugin=E2BissKeyEditor
version=2.0
url="https://raw.githubusercontent.com/Ham-ahmed/1812/refs/heads/main/E2BissKeysEditor_V2-0.tar.gz"
