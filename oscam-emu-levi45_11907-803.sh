...
echo -e "${CYAN}"
echo "################################################################"
echo "# Start downloading and installing oscam-emu-levi45_11907-803  #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1812/refs/heads/main/enigma2-plugin-softcams-oscam-emu-levi45_11907-803_all.ipk"
IPK_NAME="enigma2-plugin-softcams-oscam-emu-levi45_11907-803_all.ipk"
