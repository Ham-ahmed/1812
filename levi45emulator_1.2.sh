...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing  levi45emulator_1.2    #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1812/refs/heads/main/enigma2-plugin-extensions-levi45emulator_1.2_all.ipk"
IPK_NAME="enigma2-plugin-extensions-levi45emulator_1.2_all.ipk"
